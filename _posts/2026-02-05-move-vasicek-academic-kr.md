...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .headline { font-family: var(--serif); font-size: 42px; font-weight: 700; line-height: 1.15; margin-bottom: 20px; text-align: center; }
        .deck { font-family: var(--serif); font-size: 20px; color: var(--wsj-gray); text-align: center; font-style: italic; margin-bottom: 40px; }
        ...
        .highlight { color: #4ecdc4; font-weight: 700; }
        .footer { border-top: 3px solid var(--wsj-black); padding: 25px 0; margin-top: 50px; text-align: center; font-size: 12px; color: var(--wsj-gray); }
        .ref-list { font-size: 14px; line-height: 1.8; }
        .ref-item { margin-bottom: 8px; }
        .back-home { display: inline-block; margin-bottom: 30px; color: var(--wsj-accent); text-decoration: none; font-size: 14px; }
...
<div class="container">
    ...
    <div class="formula-box">
        ...
        <div class="formula-note">
            M<sub>t</sub>: MOVE 지수 (채권시장 내재변동성), 상태변수(state indicator)로 활용
        </div>
    </div>
    ...
    <div class="ref-list">
        ...
        <div class="ref-item">Hamilton, J. D. (1989). A new approach to the economic analysis of nonstationary time series and the business cycle. Econometrica, 57(2), 357-384.</div>
    </div>

    <div class="footer">
        © 2026 Ha Rim Jung · <a href="/">gkfla2020-bit.github.io</a>
    </div>
</div>
...
Plotly.newPlot('timeSeriesChart', [{
    ...
    annotations: [
        ...
        {x: '2022-06', y: 3.5, text: 'Inflation', showarrow: true, arrowhead: 2, ax: 0, ay: -30, font: {size: 10}}
    ]
}, {responsive: true});
...
Plotly.newPlot('modelCompareChart', [{
    ...
    annotations: [
        {x: 'RMSE', y: 0.0032, text: '<b>MOVE wins</b><br>낮을수록 좋음', showarrow: false, font: {size: 9, color: colors.green}},
        {x: 'AIC', y: -440, text: '<b>MOVE wins</b><br>Δ=13.5', showarrow: false, font: {size: 9, color: colors.green}},
        {x: 'BIC', y: -440, text: '<b>MOVE wins</b><br>Δ=9.4', showarrow: false, font: {size: 9, color: colors.green}},
        {x: 'Log-Likelihood', y: 260, text: '<b>MOVE wins</b><br>높을수록 좋음', showarrow: false, font: {size: 9, color: colors.green}}
    ]
}, {responsive: true});
...
Plotly.newPlot('lrTestChart', [{
    ...
    annotations:[{x:15,y:0.12,text:'<b>기각역</b><br>H₀ 기각 (p<0.001)',showarrow:false,font:{size:11,color:colors.accent}}]
}, {responsive:true});
...
Plotly.newPlot('grangerChart', [{
    ...
    text: ['p=0.035<br><b>유의</b>', 'p=0.461<br>유의하지 않음'],
    ...
    name: 'α = 0.05'
}], {...layout, yaxis: {title: 'p-value', range: [0, 0.6]}, showlegend: false,
    annotations: [{x: 0.5, y: 0.08, text: '유의수준 (α=0.05)', showarrow: false, font: {size: 10, color: colors.accent}}]
}, {responsive: true});
...
Plotly.newPlot('fevdChart', [{
    ...
    legend: {orientation: 'h', y: 1.1},
    annotations: [{x: 12, y: 50, text: 'MOVE 기여: 2.2%', showarrow: true, arrowhead: 2, ax: 40, ay: 0, font: {size: 11, color: colors.primary}}]
}, {responsive: true});
</script>
</body>
</html>
